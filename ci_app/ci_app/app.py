...
def deploy_new_container(image_name: str, container_name: str, ports: dict = None, environment: list or dict = None):
    try:
        ...
        docker_client.containers.run(image=image_name, name=container_name, detach=True, environment=environment, 
		volumes={'/var/lib/master_bot': {'bind': '/data', 'mode': 'rw'}}, ports=ports)
    except Exception as e:
